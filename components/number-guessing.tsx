        ...
        <div className="bg-white rounded-lg p-8 w-full max-w-md">
            ...
            <div>
                ...
                <div className="flex justify-center mb-4">
                    ...
                    className="bg-gray-100 hover:bg-gray-300 rounded-lg py-2 px-4 w-full max-w-xs"
                    placeholder="Enter your Guess"
                    />
                    <Button
                    onClick={handleGuess}
                    className="bg-gray-700 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded max-w-xs"
                    >
                        Guess
                    </Button>
                </div>
            ...
            {gameOver && (
                <div>
                    <div className="text-center mb-4 text-black">
                        ...
                        <p>You guess the correct number in {attempts} attempts</p>
                    </div>
